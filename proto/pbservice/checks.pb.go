...
// source: proto/pbservice/checks.proto
...
func (*HealthCheck) Descriptor() ([]byte, []int) {
	return fileDescriptor_ac1debbe072e41de, []int{0}
}
...
func (*HeaderValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_ac1debbe072e41de, []int{1}
}
...
func (*HealthCheckDefinition) Descriptor() ([]byte, []int) {
	return fileDescriptor_ac1debbe072e41de, []int{2}
}
...
func (*CheckType) Descriptor() ([]byte, []int) {
	return fileDescriptor_ac1debbe072e41de, []int{3}
}
...
func init() { proto.RegisterFile("proto/pbservice/checks.proto", fileDescriptor_ac1debbe072e41de) }

var fileDescriptor_ac1debbe072e41de = []byte{
	...
	,
}
...
func (m *HealthCheck) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ServiceTags) > 0 {
		for iNdEx := len(m.ServiceTags) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintChecks(dAtA, i, uint64(len(m.ServiceTags[iNdEx])))
			i--
			dAtA[i] = 0x4a
		}
	}
	if len(m.ServiceName) > 0 {
		...
		i = encodeVarintChecks(dAtA, i, uint64(len(m.ServiceName)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.ServiceID) > 0 {
		...
		i = encodeVarintChecks(dAtA, i, uint64(len(m.ServiceID)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.Output) > 0 {
		...
		i = encodeVarintChecks(dAtA, i, uint64(len(m.Output)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.Notes) > 0 {
		i -= len(m.Notes)
		copy(dAtA[i:], m.Notes)
		i = encodeVarintChecks(dAtA, i, uint64(len(m.Notes)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Status) > 0 {
		...
		i = encodeVarintChecks(dAtA, i, uint64(len(m.Status)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Name) > 0 {
	...
	if len(m.Node) > 0 {
		i -= len(m.Node)
		copy(dAtA[i:], m.Node)
		i = encodeVarintChecks(dAtA, i, uint64(len(m.Node)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *HeaderValue) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Value) > 0 {
		for iNdEx := len(m.Value) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintChecks(dAtA, i, uint64(len(m.Value[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *HealthCheckDefinition) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i -= n4
	i = encodeVarintChecks(dAtA, i, uint64(n4))
	i--
	dAtA[i] = 0x1
	i--
	dAtA[i] = 0x8a
	if len(m.AliasService) > 0 {
		...
		i = encodeVarintChecks(dAtA, i, uint64(len(m.AliasService)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x82
	...
	if len(m.AliasNode) > 0 {
		...
		i = encodeVarintChecks(dAtA, i, uint64(len(m.AliasNode)))
		i--
		dAtA[i] = 0x7a
	}
	if m.GRPCUseTLS {
	...
	if len(m.GRPC) > 0 {
		i -= len(m.GRPC)
		copy(dAtA[i:], m.GRPC)
		i = encodeVarintChecks(dAtA, i, uint64(len(m.GRPC)))
		i--
		dAtA[i] = 0x6a
	}
	if len(m.Shell) > 0 {
		i -= len(m.Shell)
		copy(dAtA[i:], m.Shell)
		i = encodeVarintChecks(dAtA, i, uint64(len(m.Shell)))
		i--
		dAtA[i] = 0x62
	}
	if len(m.DockerContainerID) > 0 {
		...
		i = encodeVarintChecks(dAtA, i, uint64(len(m.DockerContainerID)))
		i--
		dAtA[i] = 0x5a
	}
	if len(m.ScriptArgs) > 0 {
		for iNdEx := len(m.ScriptArgs) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintChecks(dAtA, i, uint64(len(m.ScriptArgs[iNdEx])))
			i--
			dAtA[i] = 0x52
		}
	}
	if m.OutputMaxSize != 0 {
		i = encodeVarintChecks(dAtA, i, uint64(m.OutputMaxSize))
		i--
		dAtA[i] = 0x48
	}
	...
	i -= n5
	i = encodeVarintChecks(dAtA, i, uint64(n5))
	i--
	dAtA[i] = 0x42
	...
	i -= n6
	i = encodeVarintChecks(dAtA, i, uint64(n6))
	i--
	dAtA[i] = 0x3a
	...
	i -= n7
	i = encodeVarintChecks(dAtA, i, uint64(n7))
	i--
	dAtA[i] = 0x32
	if len(m.TCP) > 0 {
		i -= len(m.TCP)
		copy(dAtA[i:], m.TCP)
		i = encodeVarintChecks(dAtA, i, uint64(len(m.TCP)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Method) > 0 {
	...
	if len(m.Header) > 0 {
		for k := range m.Header {
			...
			i -= len(k)
			copy(dAtA[i:], k)
			i = encodeVarintChecks(dAtA, i, uint64(len(k)))
			i--
			dAtA[i] = 0xa
			i = encodeVarintChecks(dAtA, i, uint64(baseI-i))
			i--
			dAtA[i] = 0x1a
		}
	}
	...
	if len(m.HTTP) > 0 {
		i -= len(m.HTTP)
		copy(dAtA[i:], m.HTTP)
		i = encodeVarintChecks(dAtA, i, uint64(len(m.HTTP)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *CheckType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ProxyGRPC) > 0 {
		...
		i = encodeVarintChecks(dAtA, i, uint64(len(m.ProxyGRPC)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xc2
	...
	if len(m.ProxyHTTP) > 0 {
		...
		i = encodeVarintChecks(dAtA, i, uint64(len(m.ProxyHTTP)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xba
	...
	if m.FailuresBeforeCritical != 0 {
		i = encodeVarintChecks(dAtA, i, uint64(m.FailuresBeforeCritical))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb0
	...
	if m.SuccessBeforePassing != 0 {
		i = encodeVarintChecks(dAtA, i, uint64(m.SuccessBeforePassing))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa8
	...
	i -= n10
	i = encodeVarintChecks(dAtA, i, uint64(n10))
	i--
	dAtA[i] = 0x1
	i--
	dAtA[i] = 0x9a
	...
	i -= n11
	i = encodeVarintChecks(dAtA, i, uint64(n11))
	i--
	dAtA[i] = 0x1
	i--
	dAtA[i] = 0x92
	...
	i -= n12
	i = encodeVarintChecks(dAtA, i, uint64(n12))
	i--
	dAtA[i] = 0x1
	i--
	dAtA[i] = 0x8a
	...
	i -= n13
	i = encodeVarintChecks(dAtA, i, uint64(n13))
	i--
	dAtA[i] = 0x4a
	if len(m.TCP) > 0 {
		i -= len(m.TCP)
...
func (m *HealthCheckDefinition) Size() (n int) {
	...
	if len(m.Header) > 0 {
		for k, v := range m.Header {
			...
			_ = v
			l = v.Size()
			mapEntrySize := 1 + len(k) + sovChecks(uint64(len(k))) + 1 + l + sovChecks(uint64(l))
			n += mapEntrySize + 1 + sovChecks(uint64(mapEntrySize))
		}
	}
	l = len(m.Method)
	if l > 0 {
	...
	n += 1 + l + sovChecks(uint64(l))
	if m.OutputMaxSize != 0 {
		n += 1 + sovChecks(uint64(m.OutputMaxSize))
	}
	if len(m.ScriptArgs) > 0 {
...
func (m *CheckType) Size() (n int) {
	...
	if len(m.Header) > 0 {
		for k, v := range m.Header {
			...
			l = v.Size()
			mapEntrySize := 1 + len(k) + sovChecks(uint64(len(k))) + 1 + l + sovChecks(uint64(l))
			n += mapEntrySize + 2 + sovChecks(uint64(mapEntrySize))
		}
	}
	if m.SuccessBeforePassing != 0 {
		n += 2 + sovChecks(uint64(m.SuccessBeforePassing))
	}
	if m.FailuresBeforeCritical != 0 {
		n += 2 + sovChecks(uint64(m.FailuresBeforeCritical))
	}
	l = len(m.ProxyHTTP)
	if l > 0 {
		n += 2 + l + sovChecks(uint64(l))
	...
	if m.OutputMaxSize != 0 {
		n += 2 + sovChecks(uint64(m.OutputMaxSize))
	}
	l = len(m.Body)
	if l > 0 {
		n += 2 + l + sovChecks(uint64(l))
